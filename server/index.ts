...
// Serve brochures from attached_assets with proper headers
app.use('/brochures', (req, res, next) => {
  // Set proper headers for PDF files only
  ...
  next();
}, express.static(path.join(process.cwd(), 'attached_assets/brochures'), {
  setHeaders: (res, path) => {
